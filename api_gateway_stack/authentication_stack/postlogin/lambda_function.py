...
def lambda_handler(event, context):
  ...
  cookie_objects = [f'access_token_cookie={access_token}; SameSite=Strict; Path=/; Secure; HttpOnly',f'csrf={csrf}; Path=/;','csrf_state=deleted; Path=/; Max-Age=0;','next=deleted; Path=/; Max-Age=0;','logged_in=true; Path=/;']
