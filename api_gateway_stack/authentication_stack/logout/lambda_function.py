...
def lambda_handler(event, context):
        return {
           "cookies" : ['access_token_cookie=deleted; Path=/; Max-Age=0;','csrf=deleted; Path=/; Max-Age=0;','logged_in=deleted; Path=/; Max-Age=0;', 'access_token_expires=deleted; Path=/; Max-Age=0;'],
